...
class TestAblationConfig:
    ...
    def test_default_config(self):
        ...
        assert config.use_split is True
        assert config.use_death is True
        assert config.use_merge is True
        assert config.use_routing is True
        assert config.use_energy is True
        assert config.use_messaging is True
